...
public class FibPair {
    ...
    private static void nextText( Integer bigger
        ...
        Pair<Integer> thisPair = new Pair<Integer>(bigger, smaller);
    ...
    private static Pair<Integer> nextPairAfter( Pair<Integer> oldPair) {
        return new Pair<Integer>(oldPair.getFirst() + oldPair.getSecond(), Math.max(oldPair.getFirst(), oldPair.getSecond()));
    }
